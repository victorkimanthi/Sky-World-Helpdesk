...
public class AddAgent implements HttpHandler {
    public void handleRequest(HttpServerExchange httpServerExchange) throws Exception {
        ...
        String userAccountApplicationUserGroupQuery = "insert into user_account_application_user_group (user_account_id,application_user_group_id) values (:user_account_id,3)";
...
//                    System.out.println("queryDataForRegisterAdmin:"+queryData);
                    ...
                    response.put("message", queryData.get("email") + " has been successfully registered as an agent of " + organizationName);
...
//            String recipient = "victorkimanthi556@gmail.com";
            ...
            try {
                ...
                if (newDateTime != null) {
                    someHtmlMessage = "Hello " + queryData.get("first_name")+ "!" + "Welcome to  Sky World Helpdesk.You have been successfully registered as an agent  for " + organizationName + ".Your first time password is :<b style='color:blue;'>" + securePassword + "</b>.It is going to to expire on <b style='color:blue;'>"  + dateNow.format(newDateTime) + "</b>.Please change it before it expires or you will not be able login to the system.";
                }
