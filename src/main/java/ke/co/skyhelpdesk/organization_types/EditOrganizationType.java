...
public class EditOrganizationType implements HttpHandler {
    public void handleRequest(HttpServerExchange httpServerExchange) {
        ...
        String sqlQuery = "UPDATE  organization_type SET organization_type_name=:organization_type_name,organization_type_description =:organization_type_description where organization_type_id=:organization_type_id";
...
//            } else {
        ...
        try {
            ...
            response.put("message", "The organization type details have been updated successfully");
