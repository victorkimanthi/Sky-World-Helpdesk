...
public class AgentLogin  implements HttpHandler {
...
//        String deleteTokenQuery = "delete from access_token where user_account_id=:user_account_id";
        ...
        try {
            if (queryData != null && !queryData.isEmpty()) {
                ...
                results.get(0).get("national_id_number");//linked-hashmap containing a nationality_id_number
                    ...
                    if (queryData.containsValue("")) {
                        ...
                        if (isFtp) {
                            if (userPasswordString.equals(queryData.get("user_password"))) {
                                ...
                                System.out.println("user_account_id:" + userAccountId);
